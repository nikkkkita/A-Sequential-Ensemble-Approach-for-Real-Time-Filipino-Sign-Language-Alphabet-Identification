...
class App(customtkinter.CTk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.knn_rf_model = joblib.load('FINALMODEL_knn_rf_classifier.joblib')
        args = self.get_args()
        ...
        back_icon = Image.open("icons/arrow.png")
        ...
        #ABOUTUS PAGE ----------------------------------------------------------------------------------------------------------------------------------
        aboutus_images =[
            {"path": "icons/cath.jpg", "label": "Catherine N. Cahilog\nc.cahilog.519535@umindanao.edu.ph"},
            {"path": "icons/feranz.jpg", "label": "Feranz C. Salonga\nf.salonga.517312@umindanao.edu.ph"},
            {"path": "icons/nikki.png", "label": "Nikkita A. Yee\nn.yee.517677@umindanao.edu.ph"},
        ]
    ...
    def update_camera(self):
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                final_prediction = self.knn_rf_model.predict([pre_processed_landmark_list])
                self.predicted_class_index = final_prediction[0] 
